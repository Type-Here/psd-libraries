...
int input_array_str(int *arr,char* line, int *pos); //Alloca Staticamente

int *input_array_dyn(int *size, char *line);  //Alloca Dinamicamente
int *concatena_vet(int *a1, int *a2, int n1, int n2);
...
/*- Algoritmi Ricorsivi - */
void selection_sort_rec(Item*, int);
int BinarySearchRec(int*, int, int);